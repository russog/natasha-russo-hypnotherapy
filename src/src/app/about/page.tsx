    ...
    return (
        <section className="relative overflow-hidden">
            ...
            <div className="md:grid md:grid-cols-2 md:auto-rows-min">
                ...
                <div className="mt-5 md:mt-15 mx-auto max-w-5xl px-6 md:row-start-2 md:col-start-1 md:w-full">
                ...
                <div className="relative z-10 mt-5 md:mt-15 mx-auto max-w-5xl px-6 md:row-start-2 md:col-start-2">
