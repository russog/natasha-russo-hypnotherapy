        ...
        <main className="mx-auto max-w-5xl px-4 py-12">
            <header className="mb-10">
                ...
                <p className="mt-2 text-neutral-600">
                    Practical, plain-English writing on hypnotherapy and related topics.
                </p>
            </header>
                ...
                {posts.map((post) => (
                    ...
                    >
                        ...
                        <div className="p-6">
                            ...
                            <p className="mt-3 text-neutral-600">{post.frontmatter.excerpt}</p>

                            <div className="mt-5 text-sm font-medium text-neutral-900">
                                Read more <span className="transition group-hover:translate-x-0.5 inline-block">→</span>
                            </div>
                        </div>
                    </Link>
                ))}
